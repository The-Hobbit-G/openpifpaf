...
evalxp='opp_train_resnet50_cocodet'
evalepoch=150


xpdir="/scratch/izar/jiguo/val/cocodet/resnet50/${SLURM_JOB_NAME}"
...
do
  evalfrom="/scratch/izar/jiguo/train/cocodet/resnet50/${evalxp}/checkpoints/${evalxp}.pt.epoch${cpepoch}"
